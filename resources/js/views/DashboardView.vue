    ...
    <div class="container mx-auto px-4 py-8 flex">
      ...
      <div class="flex-grow mx-4">
        ...
        <ul v-if="posts.length" class="max-w-2xl mx-auto space-y-6">
          <li v-for="post in posts" :key="post.id" class="border border-gray-200 bg-white rounded-lg px-6 pt-4 pb-7 shadow-sm hover:shadow-md transition-shadow duration-300">
            ...
            <div class="flex justify-between items-center">
              ...
              <div class="flex space-x-4">
                <button @click="likePost(post.id)" class="flex items-center text-gray-500 hover:text-blue-500 transition-colors duration-300">
